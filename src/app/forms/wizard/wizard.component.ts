...
export class WizardComponent implements OnInit {
  ...
  inicializarFromularios() {

    this.formTbl1 = new FormGroup({
      deparmento: new FormControl(0, [Validators.required]),
      municipio: new FormControl(0, [Validators.required]),
      aldea: new FormControl(0, [Validators.required]),
      cantdadFamilias: new FormControl(0, [Validators.required]),
    });
  ...
  /**EVENTOS DE LLAMADO AL API */

  onSubmitTbl1() {

    if (this.formTbl1.invalid) {
